...
const Pacientes = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setError('ERR-FRONT-001: Erro na busca. Tente novamente.');
      console.error('Erro:', error);
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.message || 'ERR-FRONT-002: Erro ao salvar paciente. Verifique os dados e tente novamente.');
    } finally {
  ...
  const handleDelete = async (paciente) => {
    ...
    try {
      ...
      setError(error.message || 'ERR-FRONT-002: Erro ao excluir paciente. Tente novamente.');
    }
  };
