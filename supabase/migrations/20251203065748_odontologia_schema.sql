-- Migration: Tabelas de Odontologia (Nicho)
-- Data: 2025-12-03
-- Descrição: Schema específico do módulo de Odontologia, com tabelas de pacientes, procedimentos, odontograma, etc.

-- As tabelas 'tenants' e 'auth.users' são gerenciadas pelo regiflex-core e Supabase Auth.

-- 1. Tabela: odontologia_pacientes
...
-- 2. Tabela: odontologia_odontograma
...
-- 3. Tabela: odontologia_procedimentos
...
-- 5. Tabela: odontologia_agendamentos
...
-- 6. Tabela: odontologia_faturamento
